Ext.define('ImperativBaza.view.Dokumenti.ProjektiDoc', {
    ...
    initComponent: function(config) {
        ...
        this.ProjektDocStore.getProxy().extraParams = {
            'id': this.asd
        }
        this.items = [{
            xtype: 'grid',
            id: 'ProjektdokumentiGrid',
            plugins: [cellEditing],
            store: this.ProjektDocStore,
            columns: [{
                text: 'Id',
                dataIndex: 'id',
                flex: 1,
                        ...
                        buttons: [{
                            ...
                            handler: function() {
                                ...
                                if (forma.isValid()) {
                                    ...
                                    xhr.open('POST', ImperativBaza.Constants.ip+'ProjektuploadDoc/', true);
                                    xhr.onload = function() {
                                        if (xhr.status === 200) {
                                            window.destroy();
                ...
                items: [{
                    ...
                    handler: function(grid, rowIndex, colIndex) {
                        ...
                        if (filename) {
                            window.open(ImperativBaza.Constants.ip+'Projektdowndoc/' + filename + '');
                        } else {
