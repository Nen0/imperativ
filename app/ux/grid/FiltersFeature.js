...
Ext.define('Ext.ux.grid.FiltersFeature', {
    ...
    /**
     * @private Create the Filter objects for the current configuration, destroying any existing ones
 first.
     */
    createFilters: function() {
        //console.log(this.getGridPanel().store)
        var me = this,
            ...
            store = grid.store,
            fields =  store.getProxy().getModel().fields,
            field,
            filter,
            state;
...
>:
     ...
     *
     *         {filters:[{"field":"someDataIndex","comparison":"someValue1","type":"someValue2","value"
:"someValue3"}]}
     *
